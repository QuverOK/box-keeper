...
function invalidateItemRelatedQueries(qc: ReturnType<typeof useQueryClient>, boxId: string, storageId: string, itemId?: string) {
...
export function useUpdateItem(itemId: string, boxId: string, storageId: string) {
    const qc = useQueryClient();
