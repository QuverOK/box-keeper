/**
 * Darkens a hex color by the given amount (0–1).
 * Falls back to the original value if the input is not a parseable hex string.
 */
...
/** True when a box color may be hard to see on the storage canvas during search. */
...
/**
 * Returns '#000000' or '#ffffff' — whichever provides better WCAG contrast
...
/**
 * Returns a semi-transparent border color that remains visible against the
 * given background: dark for light boxes, light for dark boxes.
 */
